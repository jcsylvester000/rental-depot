...
export const metadata: Metadata = {
  title: "Find a property — Rental Depot",
    ...
    <>
      ...
      <div className="wrap" id="main">
        <div style={{ paddingTop: 28 }}>
          <span className="eyebrow">Find a property</span>
          <h1 style={{ fontSize: "clamp(28px,4vw,40px)", marginTop: 8 }}>Available properties</h1>
        </div>
